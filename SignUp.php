          ...
          <div class = "col">
            <!-- Agree to T&C -->
              ...
              <label class = "form-check-label" for = "TnCAcceptance">
                I acknowledge that I have read the <a class = "text-warning" href = "#">terms and conditions</a>, and my continued use of the website is subject to these terms and conditions. <span class = "badge badge-warning">Important</span> 
              </label>
            </div>
          </div>
        </div>
