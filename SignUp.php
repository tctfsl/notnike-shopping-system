...
<html lang = "en">
  ...
  <body>
    ...
    <div class = "container"><br>
      ...
      <form method = "post" action = "back/sys-process-signup.php">
        ...
        <!-- Passwords and phone number row -->
        <div class = "row">
          <div class = "col">
            <!-- Password -->
	          <div class = "form-group">
          ...
          <div class = "col">
            ...
            <div class = "form-group">
              ...
              <input type = "text" pattern = "[0-9]{10,11}" class = "form-control" id = "phoneNo" name = "phoneNo" placeholder = "Phone Number" aria-describedby = "phoneNoHelp" required>
              <small id = "phoneNoHelp" class = "form-text text-muted">Please enter your mobile phone number, no dash required.</small>
            </div>
          </div>
        </div>
          ...
          <div class = "col">
            <!-- Agree to T&C -->
              ...
              <label class = "form-check-label" for = "TnCAcceptance">
                I acknowledge that I have read the <a class = "text-info" href = "#">terms and conditions</a>, and my continued use of the website is subject to these terms and conditions. <span class = "badge badge-info">Important</span> 
              </label>
            </div>
          </div>
        </div>
        ...
        <div class = "row">
          <div class = "col">
            <!-- Submit button -->
              ...
              <p>Already have an account? <a class = "text-info" href = "UserSignIn.php">Sign in</a></p>
